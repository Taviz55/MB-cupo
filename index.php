        ...
        <div class="col">
            <div class="jumbotron">
                <div class="start_station">      
                    <h5 class="text-dark">Estación de inicio: <span class="badge badge-primary"><?= $start_station[1] ?></span></h5>
                    <h5 class="text-dark">Metrobus: <span class="badge badge-primary"><?= $selected_metrobus[0] ?></span></h5>               
                </div>
                <div id="content">
